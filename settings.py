...
#DETECTION_MODEL_YOLOv9 = MODEL_DIR / 'bestV9_SEP.pt'
...
DETECTION_MODEL_FASTER = MODEL_DIR / 'FASTER_RCNN_5EPOCHS.pth'
#DETECTION_MODEL_FASTER = MODEL_DIR / 'FASTER_RCNN.pth'
